...
export const ProductPage = () => {
    ...
    return (
        <div className='md:m-8 m-4'>
            ...
            {!!product && (
                <div className='p-8 rounded-xl md:w-[80vw] flex flex-col justify-center items-start cursor-pointer mt-8'>
                    <img src={product.photo} alt={product.name} />
                    <p>
                        <strong>Название:</strong> {product.name}
                    </p>
                    <p>
                        <strong>Страна производителя:</strong> {product.manufacturer}
                    </p>
                    <p>
                    ...
                    {authorized && (
                        <button className='bg-green-400 text-white w-full rounded-xl mt-2 py-1 ' onClick={handleClick}>
